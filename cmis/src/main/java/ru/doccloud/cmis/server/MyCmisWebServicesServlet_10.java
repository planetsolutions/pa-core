...
@Component
public class MyCmisWebServicesServlet_10 extends AstractWebServicesServlet {
	...
	public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            final Resource wsdlResource = resourceLoader.getResource("classpath:cmis10/CMISWS-Service.wsdl.template");
            final Resource coreResource = resourceLoader.getResource("classpath:cmis10/CMIS-Core.xsd.template");
            final Resource msgResource = resourceLoader.getResource("classpath:cmis10/CMIS-Messaging.xsd.template");
