...
public class FileBridgeCmisService extends AbstractCmisService implements CallContextAwareCmisService {
    ...
    public TypeDefinitionList getTypeChildren(String repositoryId, String typeId, Boolean includePropertyDefinitions,
        ...
        try {
            ...
            LOGGER.error("getTypeChildren(): Exception {}", e);
        }
        return null;
    }
    ...
    public TypeDefinition getTypeDefinition(String repositoryId, String typeId, ExtensionsData extension) {
        try {
            ...
            LOGGER.error("getTypeDefinition(): Exception {}", e);
        }
        return null;
    }
    ...
    public ObjectData getFolderParent(String repositoryId, String folderId, String filter, ExtensionsData extension) {
        try {
            ...
            LOGGER.error("getFolderParent(): Exception {}", e);
        }
        return null;
    }
    ...
    public List<ObjectParentData> getObjectParents(String repositoryId, String objectId, String filter,
        ...
        try {
            ...
            LOGGER.error("getObjectParents(): Exception {}", e);
        }
        return null;
    }
    ...
    public void deleteObjectOrCancelCheckOut(String repositoryId, String objectId, Boolean allVersions,
        ...
        try {
            ...
            LOGGER.error("deleteObjectOrCancelCheckOut(): Exception {}", e);
        }
    }
    ...
    public FailedToDeleteData deleteTree(String repositoryId, String folderId, Boolean allVersions,
        ...
        try {
            ...
            LOGGER.error("deleteTree(): Exception {}", e);
        }
        return null;
    }
    ...
    public ObjectData getObjectByPath(String repositoryId, String path, String filter, Boolean includeAllowableActions,
        ...
        try {
            ...
            LOGGER.error("getObjectByPath(): Exception {}", e);
        }
        return null;
    }
    ...
    public Properties getProperties(String repositoryId, String objectId, String filter, ExtensionsData extension) {
        ...
        try {
            object = getRepository().getObject(getCallContext(), objectId, null, filter, false, false, this);
        } catch (Exception e) {
            LOGGER.error("query(): Exception {}", e);
        }
        return object != null ? object.getProperties() : null;
    }
    ...
    public void moveObject(String repositoryId, Holder<String> objectId, String targetFolderId, String sourceFolderId,
        ...
        try {
            ...
            LOGGER.error("moveObject(): Exception {}", e);
        }
    }
...
//        }
    ...
    public void updateProperties(String repositoryId, Holder<String> objectId, Holder<String> changeToken,
        ...
        try {
            ...
            LOGGER.error("updateProperties(): Exception {}", e);
        }
        LOGGER.info("entering updateProperties()");
    }
    ...
    public List<BulkUpdateObjectIdAndChangeToken> bulkUpdateProperties(String repositoryId,
        ...
        try {
            ...
            LOGGER.error("bulkUpdateProperties(): Exception {}", e);
        }
        return null;
    }
    ...
    public Properties getPropertiesOfLatestVersion(String repositoryId, String objectId, String versionSeriesId,
        ...
        ObjectData object = null;
        try {
            object = getRepository().getObject(getCallContext(), objectId, versionSeriesId, filter, false,
                    false, null);
        } catch (Exception e) {
            LOGGER.error("getPropertiesOfLatestVersion(): Exception {}", e);
        }
