        ...
        try {
            ...
            if(LOGGER.isTraceEnabled()) {
                for (String currentKey : parameters.keySet()) {
                    LOGGER.trace("init(): Key = {} -> Value = {}", currentKey, parameters.get(currentKey));
                }
            }
...
//            final String user = parameters.get("cmisinituser");
//
//            LOGGER.trace("init(): cmis init user {}", user);
    ...
    //        todo add users creds fro jwt token
            LOGGER.trace("getService(): context {}", context);
    ...
    //        if login successfull, create cmis repository
            ...
            if(fsr == null) {
                ...
                fsr = new FileBridgeRepository(repositoryId, rootPath, typeManager, crudService, fileService);
            ...
            LOGGER.error("getService(): exception {}", e);
        }
        return null;
    }
