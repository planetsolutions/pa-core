...
public class DocumentControllerGetTest {
    ...
    final UUID EXISTING_UUID = UUID.fromString("6dc3a244-0df2-44fc-a576-73cc0b5ca38e");
    ...
    @Test
    public void getDocByTypeTest(){
        try {
            final String token = getJwtToken();
            if(!StringUtils.isBlank(token)) {
                URIBuilder uriBuilder = new URIBuilder();
                uriBuilder.setScheme(HTTP_SCHEMA_URL).setHost(URL).setPort(PORT).setPath(BASIC_PATH + "type/folder");
