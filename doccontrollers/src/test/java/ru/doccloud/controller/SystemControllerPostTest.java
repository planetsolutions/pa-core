...
public class SystemControllerPostTest {
    ...
    private final static String SERVER_URL = "http://localhost:8888/jooq/api/system";
    private final static String URL = "localhost";
    private final static int PORT = 8888;
    private final static String UPDATE_PATH= "jooq/api/system/updatecontent/";
    private final static String ADD_CONTENT_PATH = "jooq/api/system/addcontent/";
...
//        @Test
    public void updateContentTest(){
        try {
            ...
            if(!StringUtils.isBlank(token)) {
                URIBuilder uriBuilder = new URIBuilder();
//                uriBuilder.setScheme(HTTP_SCHEMA_URL).setHost(URL).setPort(PORT).setPath(UPDATE_PATH + UUID.fromString("e5145110-f304-4682-a274-ec3dd746b1c4"));
                uriBuilder.setScheme(HTTP_SCHEMA_URL).setHost(URL).setPort(PORT).setPath(UPDATE_PATH + UUID.randomUUID());
                URI uri = uriBuilder.build();
    ...
    public void deleteDocTest() {
        try {
            ...
            if(!StringUtils.isBlank(token)) {
                URIBuilder uriBuilder = new URIBuilder();
//                uriBuilder.setScheme(HTTP_SCHEMA_URL).setHost(URL).setPort(PORT).setPath(BASIC_PATH + UUID.fromString("e5145110-f304-4682-a274-ec3dd746b1c4"));
                uriBuilder.setScheme(HTTP_SCHEMA_URL).setHost(URL).setPort(PORT).setPath(BASIC_PATH + UUID.randomUUID());
                URI uri = uriBuilder.build();
