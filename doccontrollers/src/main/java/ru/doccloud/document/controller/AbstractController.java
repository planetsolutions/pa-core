...
import ru.doccloud.service.CommonService;
...
public abstract class AbstractController {
    ...
    private final CommonService crudService;

    FileService fileService;

    AbstractController(FileService fileService, CommonService crudService) throws Exception {
